...
from logisticnormal.PurePython import Wishart as Wis_python
from logisticnormal.PurePython.wishart import wishart_var, invwishartrand
from logisticnormal import Wishart
